...
include get_parent_theme_file_path( '/inc/mypage/user-helper-functions.php' );
include get_parent_theme_file_path( '/inc/mypage/user-buttons.php' );
include get_parent_theme_file_path( '/inc/mypage/user-templates.php' );
